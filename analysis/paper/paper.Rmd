...
```
For the RSPD, the logistic model achieved a p-value of 0.108, and could therefore not be rejected. Based on the available data, this model therefore represents the best explanation of the data. Given the failure to reject the logistic model, the subsequent step of also including a comparison with CPL models was not strictly necessary, but the result of this procedure further substantiates the finding as the logistic model is the best among the considered candidates.
...
It is established that Stone Age sites in the region date to the period from before the earliest ^14^C-dates, and at least from as far back as around 9300 BCE [e.g. @damlien2018b; @glorstad2016]. While the SSPD starts from c. 9500 BCE, the RSPD show no evidence of human activity until c. 8500–8300 BCE. What has caused the lack of ^14^C-dates from this earliest period has been given many possible explanations through the years. These range from from taphonomic loss to diverse environmental and/or cultural factors, such as the use of shrubs for fuel or use of rapidly deteriorating seal blubber for burning, a preference for consuming raw, dried or fermented food, and possibly a lack of reliable access to firewood [e.g. @damm2022]. While taphonomic and ecological factors cannot be written off, we view it as likely that the initial jump at the start of RSPD, combined with the magnitude of the SSPD in the period preceding this, suggest that cultural rather than environmental factors are central drivers behind the observed pattern. 

The considered models indicate that after the initial jumps, some process of decrease in shoreline dated site frequency occurs throughout the period, contrasted by a general stationary frequency of ^14^C-dated material. An immediate explanation of this mismatch could be that the SSPD mainly reflects variations in land-use and mobility patterns, while the RSPD mainly reflects population numbers. A common interpretation of the Early Mesolithic in the region is that the population was small but highly mobile, reflected in large numbers of short lived sites along the coast [e.g. @bjerck2017]. This is commonly seen in relation to homogeneous lithic technology over large parts of Scandinavia in this period, and what is believed to have been a rapid colonisation of the Norwegian coastline. High mobility has been seen as necessary both to maintain demographic viability among colonising groups and for it to be possible to maintain this technological uniformity over large areas [@rowley-conwy2017]. The initial peak in the SSPD could thus be congruent with a process of rapid colonisation of the Norwegian coast, coupled with a high degree of mobility, leading to the overall high site-count in the earliest period. At the same time, the lacking signal in the RSPD for this earliest period could be taken as evidence for low population numbers during the first settlement period following the deglaciation. 
...
In contrast to the findings of @berg-hansen2022, the analysis undertaken here instead indicates a drop in the number of sites through this time-interval. It has previously been suggested that a change in mobility patterns occurs from some time around 8300 BCE, involving a reduction in residential mobility [@roalkvam2022; @damlien2018b]. Furthermore, both genetic data and technological analyses of lithic inventories indicates that the initial phase of human colonisation from the south is followed by an influx, and possible mixing, of people from the east at the transition to the Middle Mesolithic period around the same time [@gunther2018; @manninen2021]. If this narrative is coupled with the data observed here, these migratory events would appear to result in a relatively sudden drop in site-count as indicated in the SSPD, which in turn could be related to a change in mobility patterns. The end of this drop corresponds to the first ^14^C-dates in the RSPD around 8300 BCE -- giving further credence to the suggestion that the appearance of material to be ^14^C-dated is mainly related to cultural and demographic processes rather than taphonomic factors. 
