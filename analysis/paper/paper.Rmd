...
```
For the RSPD, the logistic model achieved a p-value of 0.108, and could therefore not be rejected. Based on the available data, this therefore represents the best explanation of the data. For the SSPD all of the standard models could be rejected.
