...
All of the standard models could be rejected for the SSPD. Of the contrasted models, the BIC values indicate that the exponential model is the best candidate. The negative direction indicates that some overall process of reduction in the frequency of shoreline dated sites occurs over time, while the rejection of the model and clear deviations from the exponential patterns indicates that this model does not account for the entire development. Some significant deviations occurs with the model over-predicting the frequency of sites in the period from c. X--9000 BCE, followed by a significant positive peak just after 9000 BCE. The process of decline is then interrupted by positive deviations at, and with a smaller deviation around 7000 BCE. This is closely followed by a negative deviation of more magnitude than that expected under the exponential model between X and X BCE. Finally, a positive deviation occurs again at X--5000 BCE. While all of these deviations should be viewed with caution, the small magnitude and questions concerning the reliability of shoreline dating after 4000 BCE [cf. @roalkvam2023] means that the negative deviations that occur around 3000 BCE are disregarded here.
...
It is established that Stone Age sites in the region date to the period from before the earliest ^14^C-dates, and at least from as far back as around 9300 BCE [e.g. @damlien2018b; @glorstad2016]. While the SSPD achieved here starts from c. 9500 BCE, the RSPD shows no evidence of human activity until c. 8500 BCE. What has caused the lack of ^14^C-dates from this earliest period has been given many possible explanations through the years. These range from from taphonomic loss to diverse environmental and/or cultural factors, such as the use of shrubs or rapidly deteriorating seal blubber as fuel for burning, a preference for consuming raw, dried or fermented food, and possibly a lack of reliable access to firewood [see @damm2022]. While taphonomic and ecological factors cannot be excluded as part of the picture, we view it as likely that the rapid growth at the start of RSPD and the magnitude of the SSPD in the period preceding this suggest that cultural and demographic as opposed to taphonomic and environmental factors are central drivers behind the observed pattern. 

The considered models indicate that after the initial jumps of each proxy, some process of decrease in shoreline dated site frequency occurs throughout the period, contrasted by a general stationary frequency of ^14^C-dated material. An immediate explanation of this mismatch could be that the SSPD is more heavily impacted by variation in land-use and mobility patterns, while the RSPD mainly reflects population numbers.

A common interpretation of the Early Mesolithic in the region is that the population was small but highly mobile, reflected in large numbers of short lived sites along the coast [e.g. @bjerck2008; @bjerck2017]. This is commonly seen in relation to homogeneous lithic technology over large parts of Scandinavia in this period, and what is believed to have been a rapid colonisation of the Norwegian coastline. High mobility has been seen as necessary both to maintain demographic viability among colonising groups, and for it to be possible to maintain this technological uniformity over large areas [@rowley-conwy2017]. The initial peak in the SSPD could thus be congruent with a process of rapid colonisation of the Norwegian coast, coupled with a high degree of mobility, leading to the overall high site-count in the earliest period. The lacking signal in the RSPD for the first settlement period following the deglaciation could in this view reflect mobility patterns characterised by short occupational duration and corresponding pyrotechnology based on small, short-lived fires [cf. @damm2022] and low population numbers. 

Following this earliest phase, @berg-hansen2022 have argued that there is an increase in sites between c. 8000--7000 BCE in the northern part of the study area of this paper. However, their analysis covers a limited area and is based on the aggregation of point-based estimates of shoreline dates, which are aggregated within periods of variable length. Apart from the limitations with using point-based estimates for shoreline dates, the use of disjoint time-intervals of variable duration could cause issues for comparing the relative counts across these units [@bevan2021]. 

In contrast to the findings of @berg-hansen2022, the analysis undertaken here instead indicates a decline in the number of shoreline dated sites through this time-interval, with possible positive reversals of this trend just after 8000 BCE and around 7000 BCE. It has previously been suggested that a change in mobility patterns occurs from some time around 8300 BCE, involving a reduction in residential mobility [e.g. @damlien2018b; @roalkvam2022]. Furthermore, both genetic data and technological analyses of lithic inventories indicates that the initial phase of human colonisation from the south is followed by an influx, and possible mixing, of people from the east around the same time [@gunther2018; @manninen2021]. If this narrative is coupled with the data observed here, these migratory events could appear to result in a relatively sudden drop in site-count as indicated in the SSPD, which in turn could be related to a change in mobility patterns. The end of this drop also roughly corresponds to the first ^14^C-dates in the RSPD around 8300 BCE -- giving further credence to the suggestion that the appearance of material to be ^14^C-dated is mainly related to cultural and demographic processes. 

The SSPD deviates negatively from all models from c. to c. BCE, and positively just before the 4th millennium BCE. The negative deviation could possibly been seen in relation to an increase in inland activity that occurs around the same time, which is argued to reach its peak around 6000 BCE. @boaz1999 related this development to a separation of inland and coastal populations in this period. The middle of the 6th millennium BCE marks the onset of the classic Nøstvet phase [@reitan2022], which has traditionally been seen as characterised by a reduction in residential mobility, and a specialisation towards fishing. This also coincides with what @fuglestvedt2018[17] has been termed \'the great wave\' of rock art in south-eastern Norway [@fuglestvedt2018, 42--46; @glorstad2010, 216--233]. Given the rejected null-models, the stable development in RSPD over this period, and the limited sample of ^14^C-dates, it is, however, difficult to  

It is worth noting that there appears to be a corresponding peak in both proxies just after 8000 BCE and similarly a negative deviation just before 6000 BCE. This could possibly be related to an increase in population numbers following, and a  However, given that the logistic model could not be rejected for the RSPD, it is inappropriate to interpret any deviations from the Monte Carlo envelope, and so no analytical weight can be placed on the deviations in the RSPD given the present data. This is also poses a challenge for the interpretation of the SSPD.

Given the presence of people and corresponding signal in the SSPD before the start of the RSPD, and the suggested relevance of mobility patterns for the lacking signal in the RSPD in this early period, neither proxy is devoid of influence from population density or mobility patterns. Properly adjudicating this relationship will thus depend on independent data on mobility patterns. 
