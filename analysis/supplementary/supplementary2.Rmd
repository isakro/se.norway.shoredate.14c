...
The figure below displays the results of attempting to adjust parameter settings for improving the parameter search for the 5-CPL model. There only appears to minute variation in the 'value', and none of the models reach convergence. The parameters were altered one at a time, using the following code as the starting point:
```{r, eval = FALSE}
